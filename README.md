<!---
> 本README作为pull request的comment提交

# openPangu_dense opensource

## What does this PR do?

This PR introduces inference support for the openPangu dense model. By integrating the inference implementation directly into the Transformers library, we aim to ensure seamless compatibility and enable continuous updates alongside future open-source releases.
